"""
Benchmark script for the REST+MCP Server.

Measures both latency (sequential) and throughput (concurrent) for MCP endpoints.
"""
...
async def main():
    ...
    async with sse_client(server_url) as (read_stream, write_stream):
        async with ClientSession(read_stream, write_stream) as session:
            ...
            print(f"Benchmarking REST+MCP server at {server_url}")
