...
def main():
    rest_data = read_latency_data(Path('/home/exouser/rest/benchmark_results/run_2025_10_26/get_modelcard.csv'))
    mcp_data = read_latency_data(Path('/home/exouser/mcp/benchmark_results/run_2025_10_26/native/get_modelcard.csv'))
    layered_mcp_data = read_latency_data(Path('/home/exouser/mcp/benchmark_results/run_2025_10_26/layered/get_modelcard.csv'))
